...
import com.example.petskingdom.databinding.ActivityForgetPasswordBinding;
    ...
    private void recoverPassword() {
        ...
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnSuccessListener(unused -> {
                    ...
                    Toast.makeText(ForgetPassword.this, "Instructions to reset password sent to "+email, Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    //failed to send
                    progressDialog.dismiss();
                    Toast.makeText(ForgetPassword.this, "Failed to send due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
    public void back(){
